            ...
            <div className='experience-container'>
                <div className="experience-item">
                    ...
                    <ul className="experience-item-description">
                        <li>Responsible for defining release planning (the what, who, and when) to implement product delivery scope
                            on time.</li>
                        <li>Partnering with product leaders to understand the product vision and strategy, and create detailed
                            project plans.</li>
                        <li>Grooming and maintaining the product and sprint backlog, thus collaborating with engineering to
                            coordinate execution.</li>
                    </ul>
                </div>
